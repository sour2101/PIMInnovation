...
export class DashboardComponent  {
  ...
  constructor(private _appService: AppService,
    private _userPrefService:UserPreferenceService,public dialogService: DialogService,private translate:TranslateService,private _pimService:CategoryService) {
  ...
  openDialog(orgId,catId): void {
    let header;
    this.translate.get('data.lblOrgHeader').subscribe((res)=> 
    {header = res});
